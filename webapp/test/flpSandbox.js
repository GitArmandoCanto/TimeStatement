					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Time Statement Report",
									"targetURL": "#nmsptimest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nmsptimest-display": {
								"semanticObject": "nmsptimest",
								"action": "display",
								"description": "Time Statement Report",
								"title": "Time Statement Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nmsp.timest",
									"url": sap.ui.require.toUrl("nmsp/timest")
								}
							}
						}
					}
